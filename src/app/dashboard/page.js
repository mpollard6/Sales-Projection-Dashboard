...
export default function MyPipeline() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-4">Forecast: {fp.assess}</p>
      ...
      {aOpen.length===0?<p className="text-gray-400">No deals</p>:(
        <div className="bg-white rounded-xl shadow overflow-x-auto"><table className="w-full text-sm"><thead><tr className="bg-gray-100">
          ...
          <th className="px-3 py-2 text-center font-semibold text-gray-600">Close %</th><th className="px-3 py-2 text-center font-semibold text-gray-600">60d %</th>
          <th className="px-3 py-2 text-right font-semibold text-gray-600">30d $</th><th className="px-3 py-2 text-right font-semibold text-gray-600">60d $</th>
      ...
      {pOpen.length===0?<p className="text-gray-400">No deals</p>:(
        <div className="bg-white rounded-xl shadow overflow-x-auto"><table className="w-full text-sm"><thead><tr className="bg-gray-100">
          ...
          <th className="px-3 py-2 text-right font-semibold text-gray-600">1-Time</th><th className="px-3 py-2 text-right font-semibold text-gray-600">Onboard</th>
          <th className="px-3 py-2 text-right font-semibold text-gray-600">Ongoing</th><th className="px-3 py-2 text-center font-semibold text-gray-600">Pipe</th>
